...
export enum ActionTypes {
  ...
  CREATE_INTERVENTIONSET_REQUEST = "CREATE_INTERVENTIONSET_REQUEST",
  CREATE_INTERVENTIONSET_SUCCESS = "CREATE_INTERVENTIONSET_SUCCESS",
  CREATE_INTERVENTIONSET_ERROR = "CREATE_INTERVENTIONSET_ERROR",
}
