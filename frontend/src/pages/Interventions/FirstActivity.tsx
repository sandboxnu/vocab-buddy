...
const FirstActivity  = ({ title, imageUrl }: FirstActivityProps) : ReactElement => {
  return (
  <Layout>
    <Container>
      <MainContent>
        ...
        <Prompt>
          <PromptSpeech prompt="“Look at that miniscule ant! It is really, really, small.”" button={<ReplayButton scale={0.8}/>} />
        </Prompt>
        {/* <Image src={imageUrl}/> */}
